...
let modeoftransports = ["private jet", "car", "motorcycle", "scooter", "bicycle"]
//produce an array index error
console.log(modeoftransports[6])
//correct the error
console.log(modeoftransports[1])
