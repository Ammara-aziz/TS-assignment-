...
is a toddler.*/
 if (aGe=2,aGe<4){console.log("the person is a toddler")}
...
/*• If the person is at least 13 years old but less than 20, print a message that
 ...
 if (aGe=13,aGe<20){console.log("the person is a teenager")}

/*• If the person is at least 20 years old but less than 65, print a message that the person
 is an adult.*/
if (aGe=20,aGe<65){console.log("the person is an adult")}
/*• If the person is age 65 or older, print a message that the person is an elder.*/
if (aGe>=65){console.log("the person is an adult")}
